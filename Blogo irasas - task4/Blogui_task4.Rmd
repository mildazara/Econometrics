...
čia $Y=(y_1, y_2,.., y_k)^T$ - priklausomo kintamasojo reikšmių vektorius, $^T$ -transponuota,   
...
tab
```
mod3 AIC mažesnis, R^2 koeficientas - didesnis, lyginant su modč. Tad tikėtina, kad modelis *mod3* yra tikslesnis už *mod2*.
