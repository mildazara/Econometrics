...
2. Sukuriama funkcija, kuri apskaičiuoja tikimybę, kad laimėjimo balansas yra teigiamas:(Naudojamas Monte Carlo metodas: "replicate" funkcijos pagalba bandymas kartojamas 100 kartų ir  apskaičiuojamas vidurkis(=tikimybė), kad laimejimo balansas yra teigiamas)
```{r}
tikimybe<-function(n){
