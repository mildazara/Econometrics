...
Let's look at the at the forecast from the last 20 years using models drift and naive:
```{r}
dowjones2<-ts(data=dowjones, start=58, end=78) #choosing 20 last years
par(mfrow=c(1,2))
...
```
According to Drift forecast - decrese is predicted, while Naive method still shows the same prediction. In order to that, I would choose Naive method as the best to forecast this data.
